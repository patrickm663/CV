...
\profile{
  I am an aspiring actuary with a strong focus on developing open-source technologies for reporting and analytics. I am also a keen software developer with a high aptitude for statistical programming \& machine learning.
}
...
\begin{paracol}{2}
  \cvsection{Actuarial \\Qualifications}
  ...
  \begin{itemize}[label=$\circ$, leftmargin=0.4cm, labelsep=0.2cm]\bfseries
  ...
  \begin{itemize}[label=$\circ$, leftmargin=0.4cm, labelsep=0.2cm]\bfseries
    ...
    \item Stellenbosch University Dean's\\ Merit List: 6 Subjects\\
    \item Stellenbosch University Merit Bursary
    \item Maties Gymnastics \textit{Matie of the Year} 
  \end{itemize}
