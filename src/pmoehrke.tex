...
\profile{
  I am an aspiring actuary with a strong focus on developing open-source technologies for reporting and analytics. I am also a keen software developer with a high aptitude for probabilistic programming, machine learning \& cloud computing.
}
...
\begin{paracol}{2}
  ...
  \begin{itemize}[label=$\circ$, leftmargin=0.9cm, labelsep=0.43cm]
    ...
    \item Co-presented on IFRS 17 reporting using Python at the ASSA 2023 conferences. 
  \end{itemize}
  ...
  \begin{itemize}[label=$\circ$, leftmargin=0.9cm, labelsep=0.43cm]
    ...
    \item Under supervision, conducted surveys with actuarial managers to benchmark the use of data science \& analytics across South African \& UK actuarial functions. 
